...
lib.maps = {
	-- ############ maps free to use ################ - please let me know if your addon uses one of these and i will mark it accordingly
	-- Big maps.
